...
def intro(k):
    ...
    slow_typing("  will you be able to progress further than before?")
    pause(0.8)
    slow_typing("\n  To the east, the warlords of Vorreth grow bold.")
    slow_typing("  Their spies whisper of your weakness. Their armies prepare to strike at any moment.")
    pause(0.8)
    slow_typing("\n  You have three years to progress.")
    slow_typing("  Grow your kingdom. Win alliances. Fill your treasurey.")
